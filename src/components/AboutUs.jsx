      ...
      <Container textAlign='left'>
        ...
        <h3>At FOODHUB, you can customize existing recipes. This is how the community of shared recipes is created!</h3>
          ...
          <Step.Group widths={3}>
            <Step>
              <Icon name='food' />
              <Modal trigger={<Button basic><Step.Content>
            ...
            <Step>
              ...
              <Modal.Content image>
                  ...
                  <Modal.Description>
                    ...
                    <h2>No Problem!</h2>
                    <h3>When you Fork other Foodies recipes by clicking the "fork" button on their recipe, you can customize it to make it your own.</h3>
            ...
            <Step>
              ...
              <Modal.Content image>
                  ...
                  <Modal.Description>
                    <h3>Made with love by FOODHUB.</h3>
